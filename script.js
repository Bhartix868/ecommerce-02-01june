...
(function () {
  ...
  if (ageGate) {
    const verified = localStorage.getItem('viresco_age_verified');
    if (!verified) {
    ...
    if (yesBtn) yesBtn.addEventListener('click', () => {
      localStorage.setItem('viresco_age_verified', 'true');
  ...
  if (cookieBar) {
    const consent = localStorage.getItem('viresco_cookie_consent');
    if (!consent) {
    ...
    if (accept) accept.addEventListener('click', () => {
      localStorage.setItem('viresco_cookie_consent', 'accepted');
      cookieBar.classList.remove('is-visible');
    });
    if (decline) decline.addEventListener('click', () => {
      localStorage.setItem('viresco_cookie_consent', 'declined');
      cookieBar.classList.remove('is-visible');
    });
  }
